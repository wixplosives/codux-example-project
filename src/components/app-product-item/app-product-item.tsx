    ...
    return (
        ...
        >
            <div className={style(classes0.flexColumnAlignToCenter, classes.main)}>
                <ImageView resizeMode="fill" positionVertical={'center'} positionHorizontal={'center'} src={'https://static.wixstatic.com/media/1f3c0f_62b49fd6f9bb40be878c33551049c10d.jpg/v1/fill/w_500,h_500,al_c,q_85,usm_0.66_1.00_0.01/1f3c0f_62b49fd6f9bb40be878c33551049c10d.webp'} />
            </div>
            ...
            <div className={style(classes0.flexRowStretch, classes0.footer)}>
                ...
                <div className={style(classes0.flexColumnAlignToStart)}>
                    <a href="/" className={classes.productLink}>
                        ...
                        <h3 className={classes.productDesc}>Unisex scarf for casual look</h3>
                    </a></div>
